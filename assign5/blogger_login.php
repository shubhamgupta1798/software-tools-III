...
<body>
  <div class="heading1" STYLE="color: #080808;"><h1>TAKE A FIRST STEP TODAY</h1></div>
  ...
  <form method="POST">
      ...
      <div>
        ...
        <div class="c3" >
          ...
          <br>
          <br>
          <a href="blogger.php" class="c2">BACK</a>
...
$u=$_POST['uname'];
  ...
  $query = mysqli_query($con,"SELECT * FROM blogger where username = '$u' AND password = '$p'") or die("no database available");

   $row = mysqli_fetch_array($query) or die("Not a user ? Please go back .... ");

$_SESSION['username_signedin'] = $u;

   header('Location:blogger_signedin.php');

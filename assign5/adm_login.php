...
<body>
  <div class="heading1"><h1>ADMIN LOGIN</h1></div>
  ...
  <form method="POST">
      ...
      <div>
        ...
        <div class="c3">
          ...
          <br>
          <br>
          <a href="admin1.php" class="c2">BACK</a>
...
$u=$_POST['uname'];
  ...
  $query = mysqli_query($con,"SELECT * FROM admin where id = '$u' AND password = '$p'") or die("no database available");
